          ...
          >
            <Card className=" mx-auto mt-lg-5 mt-md-2" id="CardBackIMg1">
              <Card.Body>
                ...
                <Card.Title id="CardTextLog"><h5>Select Restaurant</h5></Card.Title>
              ...
              <Card.Body>
                <div className="modal-body">
                  <Card.Title><h5 >Order Date</h5></Card.Title>
              ...
              <Card.Body>
                <div className="modal-body">
                  <Card.Title id="CardTextLog"><h5>Order Time</h5></Card.Title>
                  <p>
                  <Form.Select
                    style={{ backgroundColor: 'white', color: 'black' }}
                    id="CardTextLog"

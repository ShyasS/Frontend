          ...
          <Card id="CardText" className="px-4 py-2 mb-3 col-12 mx-auto">
            <Card.Body>
              <div className="delivery-info">
                <p style={{fontSize:'16px'}} id="CardText"><b>Restaurant:</b> {branch1} {address1}</p>
              </div>
              <div className="delivery-info">
              <p style={{fontSize:'16px'}} id="CardText"><b>Date:</b> {date1}</p>
              </div>
              <div className="delivery-info">
              <p style={{fontSize:'16px'}} id="CardText"><b>Time:</b> {time}</p>
              </div>
            </Card.Body>
          </Card>
          {/* <Card id="CardText" className="px-4 py-2 mb-3 col-12 ms-3 mx-auto"> */}
            <h5>Cart Order Items<br/><hr/></h5>
          {/* </Card> */}
                      ...
                      ${item.price}
                        ...
                        <p className="col-6" id="card_item_total">
                          <p >
                            ...
                            <p style={{fontSize:'16px'}} id="CardText"> ${item.price * item.quantity}</p>
                            </span>
                          </p>
                        </p>
                        <div className="stockCounter col-6 " style={{letterSpacing:'-2px'}}>
            ...
            <div className="col-12">
              <div id="order_summary">
                <p  style={{fontSize:'16px'}} id="CardText">
                  Items total:{' '}
                  <span style={{fontSize:'16px'}} className="order-summary-values" id="CardText">
                    $
                    {(

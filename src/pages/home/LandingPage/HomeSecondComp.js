...
//       <div className='container mx-auto' style={{ paddingTop: '20px', paddingBottom: '20px' }} fluid>
//         <div className='row '>
//           <div
//             className='col-lg-6 col-12'
//           >
//             <div />
//             <img src={require('../../../assets/img/IndB5.jpeg')} className=" float-end img-thumbnail HomeSecondImg"style={{ height:'30rem',borderRadius: '30px' }} />
//           </div>
//         <div
//           className="col-lg-6 col-12 text-justify" id="HomeSecRightMain"
//         >
//           <div >
//           <h3
...
//           <br />
//           <div>
//             <h2 className=" mt-2 text-black">ENJOY AN EXCEPTIONAL JOURNEY OF TASTE</h2>
